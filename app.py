...
# Create tab layout for different sections
tabs = st.tabs(["Housing Progress", "Market Rate vs Affordable", "Locations Map", "Real Estate Trends"])

# TAB 1: HOUSING PROGRESS
# ─────────────────────────────────────────────────────────
with tabs[0]:
...
# TAB 2: MARKET RATE VS AFFORDABLE
# ─────────────────────────────────────────────────────────
with tabs[1]:
    st.subheader("Market Rate vs. Affordable Housing")
...
# TAB 4: REAL ESTATE MARKET TRENDS
# ─────────────────────────────────────────────────────────
with tabs[3]:
    st.subheader("Portsmouth Real Estate Market Trends (5-Year Overview)")
